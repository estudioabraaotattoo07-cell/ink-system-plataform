...
// Só autentica. Não consulta ink_clientes nem resolve slug/tenant aqui --
// isso é responsabilidade exclusiva de /app (rota de resolução
// server-side), pra não duplicar no navegador a mesma lógica que já existe
// no servidor.
    ...
    >
      <div className="w-full flex flex-col items-center gap-7" style={{ maxWidth: 380 }}>
        <img
          ...
          alt="INK SYSTEM"
          style={{ height: 40, width: "auto", display: "block", filter: "drop-shadow(0 0 18px rgba(201,168,76,0.4))" }}
        />
        <form
          onSubmit={entrar}
