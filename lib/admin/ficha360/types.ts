...
export type ProximoPasso360 = {
  tipo: "confirmar_email" | "realizar_primeiro_acesso" | "concluir_onboarding" | "concluir_implantacao" | "resolver_documentacao" | "corrigir_divergencia" | "acompanhar_trial" | "avaliar_assinatura" | "acompanhar_assinatura" | "nenhum_passo_identificado";
  motivo: string;
